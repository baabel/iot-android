        ...
        mDataset = new SortedList<>(Device.class, new SortedList.Callback<Device>() {
            ...
            public int compare(Device device1, Device device2) {
                ...
                if (device1.getDeviceType() ==  device2.getDeviceType()) {     // Same types
                    ...
                    if (device1.getDeviceType() == DeviceType.UNOWNED) {    // Is device1 unowned?
                        res = -1;
                    } else if (device2.getDeviceType() == DeviceType.UNOWNED) {     // Is device2 unowned?
                        res = 1;
                    } else {
                        int permissionComparision = device1.getPermits() - device2.getPermits();
            ...
            public boolean areContentsTheSame(Device oldItem, Device newItem) {
                return oldItem.getDeviceId().equals(newItem.getDeviceId())
                        && oldItem.getDeviceType().equals(newItem.getDeviceType());
            }
